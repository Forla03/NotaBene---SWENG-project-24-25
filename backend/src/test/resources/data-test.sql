...
(1, 'Test Note 1', 'This is a test note content', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 'Test Note 2', 'Another test note', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3, 'User 2 Note', 'Note from user 2', 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
